 ...
 * 
 * @param {MouseEvent} e 
 */ const $43d7963e56408b24$var$onSync = (e)=>{};
...
setTimeout(()=>{
    ...
    customButton.firstChild.addEventListener("click", (e)=>$43d7963e56408b24$var$onSync(e));
...
}, 5000); // document.addEventListener('DOMContentLoaded', () => {
